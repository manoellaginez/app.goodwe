...
  const navigate = useNavigate(); // Hook para navegação
  ...
  // Estilos CSS globais (Simulação de um arquivo CSS para o look and feel)
  const globalStyles = `
    .gastos-page-container {
        ...
        background-color: white; /* Garante o fundo claro */
    }
    ...
    /* Estilo de fundo para o card da assistente */
    .assistant-card {
...
                    Gastos
        </h1>
        <p style={{ color: secondaryTextColor, fontSize: '14px', margin: 0 }}>
...
          <p className="card-label">Gasto total</p>
          <h2 className="card-value" style={{ color: textColor }}>R$ 150,50</h2>
...
          <h2 className="card-value" style={{ color: textColor }}>R$ 5,30</h2>
...
          <p className="card-label">Média semanal</p>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2 className="card-value" style={{ color: textColor, margin: 0 }}>R$ 0,00</h2>
...
        {/* Projeção Mensal */}
        <div className="info-card">
          <p className="card-label">Projeção mensal</p>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h2 className="card-value" style={{ color: textColor, margin: 0 }}>R$ 0,00</h2>
...
            <div className="info-card assistant-card" style={{ marginBottom: '20px' }}>
