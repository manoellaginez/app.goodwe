...
export default function DetalheDispositivo({ devices, onRemoveDevice, onToggleDevice }) {
	...
	// ALTERAÇÃO AQUI: O título (h1) do dispositivo na tela de detalhes será SEMPRE vermelho
					...
					<div className="modal-content">
						...
						<div className="modal-actions">
							<button 
								...
								style={{ backgroundColor: 'var(--cor-alerta)', width: '48%', marginRight: '4%' }}
							>
								Remover
							</button>
							<button 
								...
								className="add-device-button" 
								style={{ backgroundColor: '#cccccc', width: '48%' }}
							>
								Cancelar
							</button>
						</div>
