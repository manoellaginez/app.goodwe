...
// Linha 3 (Antiga): import { FaBolt, FaDollarSign, FaPlus, FaPowerOff, BsOutlet } from 'react-icons/fa';
// -------------------------------------------------------------------------------------------------------

// CORREÇÃO: Removemos BsOutlet do pacote 'fa'
import { FaBolt, FaDollarSign, FaPlus, FaPowerOff } from 'react-icons/fa'; 
// CORREÇÃO: BsOutlet não é usado neste arquivo, mas se fosse, você o importaria assim:
        ...
        <div className="device-list-container">
            ...
            <div style={{ padding: '15px 0', color: 'var(--cor-texto-claro)' }}>
                <h1 
                    ...
                    style={{ margin: '0 0 5px', fontSize: '30px', color: titleColor }}
                >
                    Início
                </h1>
